...
```json metadata
{
  ...
  "arguments": [{"display_text":"key","key_spec_index":0,"name":"key","type":"key"},{"display_text":"start","name":"start","type":"string"},{"display_text":"end","name":"end","type":"string"},{"display_text":"count","name":"count","optional":true,"token":"COUNT","type":"integer"}],
  "syntax_fmt": "XRANGE key start end [COUNT count]",
  ...
  "tableOfContents": {"sections":[{"id":"and-special-ids","title":"- and + special IDs"},{"id":"incomplete-ids","title":"Incomplete IDs"},{"id":"exclusive-ranges","title":"Exclusive ranges"},{"id":"returning-a-maximum-number-of-entries","title":"Returning a maximum number of entries"},{"children":[{"id":"iterating-with-earlier-versions-of-redis","title":"Iterating with earlier versions of Redis"}],"id":"iterating-a-stream","title":"Iterating a stream"},{"id":"fetching-single-items","title":"Fetching single items"},{"id":"additional-information-about-streams","title":"Additional information about streams"},{"id":"examples","title":"Examples"},{"id":"redis-software-and-redis-cloud-compatibility","title":"Redis Software and Redis Cloud compatibility"},{"id":"return-information","title":"Return information"}]}
...
* Returning items in a specific time range. This is possible because
  Stream IDs are [related to time](https://redis.io/docs/latest/develop/data-types/streams).
* Iterating a stream incrementally, returning just
  a few items at every iteration. However it is semantically much more
  robust than the [`SCAN`](https://redis.io/docs/latest/commands/scan) family of functions.
...
reverse order, called [`XREVRANGE`](https://redis.io/docs/latest/commands/xrevrange), which is otherwise identical.
...
The command [`XREAD`](https://redis.io/docs/latest/commands/xread) is also able to iterate the stream.
The command [`XREVRANGE`](https://redis.io/docs/latest/commands/xrevrange) can iterate the stream reverse, from higher IDs
...
A symmetrical pattern applies to iterating the stream with [`XREVRANGE`](https://redis.io/docs/latest/commands/xrevrange). The
...
[introduction to Redis Streams document](https://redis.io/docs/latest/develop/data-types/streams).
